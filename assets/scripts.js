...
function createTask(id, text) {
    $(".list").append("<li class='item' data-id=" + id + "> <span class='itemText' contenteditable='true'>" + text + "</span> <a class='close delete'>X</a> <span class='floppy'> <i class='fa fa-floppy-o' aria-hidden='true'> </i> </span> </li>\n");
};
